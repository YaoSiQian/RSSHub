...
export const route: Route = {
    ...
    radar: [
        {
            source: ['api.wolfx.jp/jma_eew.json', 'ws-api.wolfx.jp/jma_eew'],
            target: '/jma_eew',
        },
    ],
    name: 'JMA 緊急地震速報',
...
async function handler(ctx) {
    ...
    const currentUrl = `${baseUrl}/jma_eew.json`;
    ...
    /*
{
    ...
    */
    return {
        ...
        description: art(path.join(__dirname, 'templates/jma_eew.art'), {
